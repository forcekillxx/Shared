...
bool  FXLightning::initialize(){
    pShaderProgram =  CCShaderCache::sharedShaderCache()->programForKey( kCCShader_PositionTexture );
    texture = CCTextureCache::sharedTextureCache()->addImage("lightning.png");
